...
async def view_rate(hotel_name:str, checkin:str, checkout:str, amount:int) -> dict:  #hotel_name:str, checkin:str, checkout:str, amount:int
    return company.view_rate_from_hotel(hotel_name, [checkin, checkout], amount)    #change to classroom ex.
